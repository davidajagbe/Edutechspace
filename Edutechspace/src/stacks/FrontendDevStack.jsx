...
import frontendHeaderImg from '../assets/frontendImage.jpg';
import htmlImg from '../assets/html-image.jpg';
import cssImg from '../assets/css-image.jpg';
import jsImg from '../assets/js-thumbnail.jpg';
import htmlGuide from '../assets/html-guide.jpg';
import cssGuide from '../assets/css-guide.png';
import VideoPdfModal from '../component/VideoPdfModal';
    ...
    <div className="bg-neutral-50 min-h-screen w-full">
      ...
      <div className="mx-auto flex flex-col lg:flex-row">
        ...
        <main className="lg:w-4/5 py-12 px-6 lg:px-12 space-y-16">
            ...
            >
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <ArrowLongRightIcon className="w-5 h-5 text-blue-950" />
                </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <ClockIcon className="w-5 h-5 text-blue-950" />
                </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  {[1, 2, 3, 4].map(i => (
                    <UserIcon key={i} className={`w-${i + 4} h-${i + 4} text-blue-950`} />
                  ))}
                </div>
          ...
          {showModal && (
            <VideoPdfModal type={modalType} index={selectedIndex} onClose={() => setShowModal(false)} />
          )}
